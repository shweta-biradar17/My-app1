            ...
            <paper elevation={10}>
              <Grid item xs={6}>
                <div className="input-box"> 
                    <div>
                      <TextField value={id} onChange={event => setId(event.target.value)} type="text" required id="standard-basic" label="User Id" fullWidth
                      error 
                    ...
                    <Button className="btn1" variant="contained" color="primary" style={btnstyle} onClick={handleSubmit} type="submit" value="ADD" fullWidth>
                      ADD
                    </Button>
                </div>
              </Grid>
